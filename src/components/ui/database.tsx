      ...
      >
        ...
        <g stroke="currentColor" fill="none" strokeWidth="0.4">
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <IoPulseOutline size={7} x="18" y="7"></IoPulseOutline>
            <text
              x="28"
              y="12"
              fill="white"
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <FiMonitor size={7} x="112" y="7"></FiMonitor>
            <text
              x="122"
              y="12"
              fill="white"
          ...
          <g>
            <rect
              ...
              rx="5"
            ></rect>
            <AiOutlineAppstoreAdd size={7} x="154" y="7"></AiOutlineAppstoreAdd>
            <text
              x="165"
              y="12"
              fill="white"
        ...
        <defs>
          ...
          <radialGradient id="db-blue-grad" fx="1">
            <stop offset="0%" stopColor={lightColor || "var(--secondary)"} />
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="absolute -top-3 z-20 flex items-center justify-center rounded-lg border bg-[#101112] px-2 py-1 sm:-top-4 sm:py-1.5">
          <span className="ml-2 text-[10px]">
            {title
              ? title
              : "Optimiza tu presencia digital con tecnología eficiente y experiencia de usuario"}
          </span>
        </div>
        {/* box outter circle */}
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          ...
          <div className="absolute bottom-8 left-12 z-10 h-7 rounded-full bg-[#101112] px-3 text-xs border flex items-center gap-2 ">
            ...
            <span>{buttonTexts?.first || "Rendimiento"}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 rounded-full bg-[#101112] px-3 text-xs sm:flex border items-center gap-2">
            ...
            <span>{buttonTexts?.second || "Escalabilidad"}</span>
          </div>
          {/* Circles */}
          <motion.div
